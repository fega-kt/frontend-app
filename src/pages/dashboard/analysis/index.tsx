        ...
        series: [
          {
            name: 'Natural',
            data: [
              40000, 60000, 90000, 100000, 80000, 70000, 60000, 50000, 70000,
              90000, 80000, 90000,
            ],
          },
          {
            name: 'Referral',
            data: [
              30000, 40000, 50000, 60000, 50000, 40000, 30000, 40000, 50000,
              60000, 50000, 40000,
            ],
          },
          {
            name: 'Direct',
            data: [
              50000, 60000, 40000, 30000, 40000, 50000, 60000, 70000, 80000,
              70000, 60000, 50000,
            ],
          },
        ],
                    ...
                    <tr key={row.url} className="border-t">
                      ...
                      <td className="py-2">
                        <div className="flex items-center gap-2 justify-end">
                          ...
                          <Trend value={row.viewsChange} />
                        </div>
                      </td>
                      <td className="py-2">
                        <div className="flex items-center gap-2 justify-end">
                          {row.unique.toLocaleString()}{' '}
                          <Trend value={row.uniqueChange} />
                        </div>
                      </td>
                    </tr>
                  ))}
